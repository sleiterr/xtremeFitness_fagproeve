...
import aboutUs from "../../assets/Services/about_us_background.jpg";
import StatsSection from "./StatsSection";
import aboutUsMobile from "../../assets/Services/about_us2.png";
...
const Services = () => {
  ...
  bg-no-repeat bg-right md:bg-center bg-length:[200%_100%] md:bg-cover md:aspect-8/5"
    ...
    >
      <div
        className={clsx(
          "w-full md:w-1/2 md:ml-auto px-0 md:px-6 py-8 md:py-32 md:max-w-7xl min-h-full",
      ...
      >
        ...
        <div className="flex items-center justify-center">
          <Button to="#" className="font-normal py-2 px-6">
            Læs mere
            <CtaLabel />
          </Button>
        </div>
      ...
      {servicesText.map((item) => (
        ...
        >
          <img
            ...
            alt="about us mobile"
            className="block md:hidden w-75.25 h-auto object-cover mb-16"
          />
          <div className="">
